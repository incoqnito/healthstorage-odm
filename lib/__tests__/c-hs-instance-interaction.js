    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 6;
          return Todo.updateById(editData);
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          _context4.next = 5;
          return Todo.findById(todo3.md.id);
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _context5.next = 5;
          return Todo.changedSince(todo4.md.id, todo4.md.r);
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 2:
          ...
          _context6.next = 5;
          return Todo.lockById(todo5.md.id);
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 2:
          ...
          _context7.next = 5;
          return Todo.lockById(todo6.md.id);

        case 5:
          lockValue = _context7.sent;
          _context7.next = 8;
          return Todo.unlockById(todo6.md.id, lockValue.value);
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 2:
          ...
          _context8.next = 5;
          return Todo.lockById(todo7.md.id);

        case 5:
          lockValue = _context8.sent;
          _context8.next = 8;
          return Todo.getLockDataById(todo7.md.id, lockValue.value);
    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 2:
          ...
          _context9.next = 5;
          return Todo.lockById(todo8.md.id);

        case 5:
          lockValueTodo8 = _context9.sent;
          _context9.next = 8;
          return Todo.isLockedById(todo8.md.id, lockValueTodo8.value);
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 2:
          ...
          _context10.next = 5;
          return Todo.isLockedById(todo9.md.id, '');
  ...
  return regeneratorRuntime.wrap(function _callee11$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 6:
          _context11.next = 8;
          return Todo.getArchiveBySdoId(todo10.md.id);
  ...
  return regeneratorRuntime.wrap(function _callee12$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 6:
          _context12.next = 8;
          return Todo.getRevisionsArchiveBySdoId(todo11.md.id);
    ...
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 4:
          ...
          _context13.next = 8;
          return Todo.deleteById(todos.list[todo].md.id);
