...
function () {
  ...
  _createClass(HsModel, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(where, update) {
        var opts,
            _args = arguments;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", HsModel.findOne(where, opts).then(function (matchedModel) {
      ...
      return function findOneAndUpdate(_x, _x2) {
