...
var _hsModel = _interopRequireDefault(require("./_hsModel"));
...
function () {
  ...
  _createClass(HsInstance, [{
    ...
    value: function findOne(where) {
      return this.constructor.findAll().then(function (sdos) {
        var matchedEntries = [];
    ...
    value: function findById(id) {
      ...
      return this.HsAdapter.getSdo({
        ...
        if (_this.debug) _hsDebugger.default.logConsole("HsInstance.findById", sdo, true);

        var model = _this.returnModel(sdo);
    ...
    value: function findBlobById(id) {
      ...
      return this.HsAdapter.getSdoBlob({
        ...
        if (_this2.debug) _hsDebugger.default.logConsole("HsInstance.findBlobById", blob);
        return blob;
      });
    }
    /**
    ...
    value: function findBlobFileById(id, blobId) {
      ...
      return this.HsAdapter.getSdoBlobFile({
        ...
        if (_this3.debug) _hsDebugger.default.logConsole("HsInstance.findBlobFileById", sdo, true);
        return blob;
      });
    }
    /**
    ...
    value: function create(data) {
      ...
      return this.HsAdapter.validateSdo(data).then(function (validated) {
        if (validated) {
          if (files === null) {
            return _this4.HsAdapter.createSdo(data).then(function (sdo) {
              return _this4.returnModel(sdo);
            });
          } else {
            data['files'] = files;

            var hsBlob = _this4.sdoBlobBridge(data);

            return _this4.HsAdapter.createSdoBlob(hsBlob.blobFormData).then(function (sdo) {
              return _this4.returnModel(_objectSpread({}, data, {
    ...
    value: function changedSince(id, r) {
      ...
      return this.HsAdapter.sdoHasChanged(id, r).then(function (response) {
        if (_this5.debug) _hsDebugger.default.logConsole("HsInstance.changedSince", response, true);
        return response;
      });
    }
    /**
    ...
    value: function updateById(data) {
      ...
      return this.HsAdapter.validateSdo(data).then(function (validated) {
        if (validated) {
          if (files !== null) {
            return _this6.HsAdapter.editSdo(data).then(function (sdo) {
              return _this6.returnModel(sdo);
            });
          } else {
            data['files'] = files;

            var hsBlob = _this6.sdoBlobBridge(data);

            return _this6.HsAdapter.updateSdoBlob(hsBlob.blobFormData).then(function (sdo) {
              return _this6.returnModel(_objectSpread({}, data, {
                'blobRefs': hsBlob._dataValues.sdo.blobRefs
              }));
            });
          }
    ...
    value: function bulkUpdate(bulkList) {
      ...
      return this.HsAdapter.editSdosBulk(collectedSods).then(function (response) {
        if (_this7.debug) _hsDebugger.default.logConsole("HsInstance.bulkUpdate", response, true);
        return response;
      });
    }
    /**
    ...
    value: function lockById(id) {
      ...
      return this.HsAdapter.lockItem(id).then(function (lockValue) {
        if (_this8.debug) _hsDebugger.default.logConsole("HsInstance.lockById", lockValue, true);
        return lockValue;
      });
    }
    /**
    ...
    value: function unlockById(id, lockValueId) {
      ...
      return this.HsAdapter.unlockItem(id, lockValueId).then(function (response) {
        if (_this9.debug) _hsDebugger.default.logConsole("HsInstance.unlockById", response, true);
    ...
    value: function getLockDataById(sdoId, lockValueId) {
      ...
      return this.HsAdapter.getLockData(sdoId, lockValueId).then(function (response) {
        if (_this10.debug) _hsDebugger.default.logConsole("HsInstance.getLockDataById", response, true);
        return response;
      });
    }
    /**
    ...
    value: function isLockedById(sdoId, lockValueId) {
      ...
      return this.HsAdapter.isLockedItem(sdoId, lockValueId).then(function (response) {
        if (_this11.debug) _hsDebugger.default.logConsole("isLockedById", response, true);
        return response;
      });
    }
    /**
    ...
    value: function existsInLockStateById(sdoId, lockState) {
      ...
      return this.HsAdapter.existInLockState(sdoId, lockState).then(function (response) {
        if (_this12.debug) _hsDebugger.default.logConsole("HsInstance.existsInLockStateById", response, true);
        return response;
      });
    }
    /**
    ...
    value: function deleteById(id) {
      ...
      return this.HsAdapter.deleteSdo(id).then(function (response) {
        if (_this13.debug) _hsDebugger.default.logConsole("HsInstance.deleteById", response, true);
        return response;
      });
    }
    /**
    ...
    value: function getArchiveBySdoId(sdoId) {
      ...
      return this.HsAdapter.getSdoArchive(sdoId, pageNo, pageSize).then(function (response) {
        if (_this14.debug) _hsDebugger.default.logConsole("HsInstance.getArchiveBySdoId", response, true);
        return response;
      });
    }
    /**
    ...
    value: function getRevisionsArchiveBySdoId(sdoId) {
      ...
      return this.HsAdapter.getSdoRevisionsArchive(sdoId).then(function (response) {
        if (_this15.debug) _hsDebugger.default.logConsole("HsInstance.getRevisionsArchiveBySdoId", response, true);
        return response;
      });
    }
    /**
    ...
    value: function createBlob(sdoBlob) {
      ...
      return this.HsAdapter.validateSdo(sdo).then(function (validated) {
        if (validated) {
          ...
          return _this16.HsAdapter.createSdoBlob(sdoBlob).then(function (response) {
            if (_this16.debug) _hsDebugger.default.logConsole("createBlob", response, true);
            return response;
          });
        }
      });
    ...
    value: function findAll(options) {
      ...
      return this.HsAdapter.getSdos(this.HsSchema.props.oId, this.HsSchema.props.id, options).then(function (response) {
        var list = [];
        if (_this17.debug) _hsDebugger.default.logConsole("HsInstance.findAll", response, true);

        for (var sdo in response.body) {
          var model = _this17.returnModel(response.body[sdo]);

          list.push(model);
        }

        if (_this17.debug) _hsDebugger.default.logTable(list);
        return {
          list: list,
